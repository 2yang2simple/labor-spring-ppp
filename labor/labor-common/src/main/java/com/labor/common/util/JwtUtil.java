...
public class JwtUtil {
	...
	private static final String JWT_SECRET = "dwdwdssdwrrw";
...
//		System.out.println(Base64.encodeBase64URLSafeString(encodedKey));// 7786df7fc3a34e26a61c034d5ec8245d
	...
	public static void main(String[] args) throws Exception {
        ...
        System.err.println(c.getId());//jwt
        System.err.println(c.getIssuedAt());//Mon Feb 05 20:50:49 CST 2018
        System.err.println(c.getSubject());//{id:100,name:xiaohong}
        System.err.println(c.getIssuer());//null
        System.err.println(c.get("uid", String.class));//DSSFAWDWADAS...
