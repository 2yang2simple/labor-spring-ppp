...
public class SnowFlakeIdGen {
	...
	public static void main(String[] args) {
		...
		SnowFlakeIdGen idgen = fac.create(1, 2);
		System.err.println(idgen.nextId());
		System.err.println(idgen.nextId());
		System.err.println(idgen.nextId());
		SnowFlakeIdGen idgen2 = fac.create(1, 3);
		System.err.println(idgen2.nextId());
		System.err.println(idgen2.nextId());
		System.err.println(idgen2.nextId());
	}
	...
	public static class Factory {
		...
		public SnowFlakeIdGen create(long idcId, long machineId) {
			return new SnowFlakeIdGen(this.idcBitNum, this.machineBitNum, idcId, machineId);
		}
	}
	...
	private SnowFlakeIdGen(int idcBitNum, int machineBitNum, long idcId, long machineId) {
